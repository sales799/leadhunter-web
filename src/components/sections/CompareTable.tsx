...
function Cross() {
  return (
    <svg
      className="h-5 w-5 text-red-500/60 mx-auto"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-50 dark:bg-gray-800 text-sm">
              ...
              <th className="px-6 py-4 text-center font-heading font-semibold text-gray-400">
                Others
              </th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="px-6 py-4 text-center text-sm">
                  {typeof row.others === "boolean" ? (
                    ...
                    <span className="text-gray-400 font-body">{row.others}</span>
                  )}
                </td>
              </tr>
            ))}
