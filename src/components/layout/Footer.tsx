...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-navy-900 text-white overflow-hidden">
      ...
      <div className="container-lg relative py-16 lg:py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-400 leading-relaxed font-body max-w-xs">
              ...
              sources, score across 49 signals, close deals 90 days ahead.
            </p>
            ...
            >
              ...
              <button
                type="submit"
                className="rounded-lg bg-blue-600 px-3 py-2 text-xs font-semibold text-white font-heading hover:bg-blue-500 transition-colors"
              >
                Subscribe
              </button>
            </form>
