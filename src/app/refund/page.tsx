    ...
    <>
      ...
      <Section bg="white">
        <div className="mx-auto max-w-3xl prose prose-lg prose-gray">
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-0">Our Commitment</h2>
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">14-Day Free Trial</h2>
          <ul className="text-gray-600 space-y-2">
            <li>All new users receive a 14-day free trial with full access to all features in their selected plan.</li>
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">Monthly Subscriptions</h2>
          <ul className="text-gray-600 space-y-2">
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">Annual Subscriptions — 30-Day Money-Back Guarantee</h2>
          <ul className="text-gray-600 space-y-2">
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">Enterprise Plans</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">How to Request a Refund</h2>
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">Refund Method</h2>
          <ul className="text-gray-600 space-y-2">
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">Exceptions</h2>
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">Plan Changes</h2>
          <ul className="text-gray-600 space-y-2">
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 mt-10">Contact Us</h2>
          <p className="text-gray-600 leading-relaxed">
